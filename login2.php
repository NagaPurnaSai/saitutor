...
if (isset($_POST['submit']) ) {
  ...
  if ($valid) {
    ...
    echo "<script>
    alert('login2 failed. Incorrect username or password.')
    </script>";
  }
}
?>
...
<head>
    ...
    <button class="btn btn-sm btn-outline-danger " onclick="window.location.href='loginhome.php'">Back</button>
...
<div class="container d-flex justify-content-center align-items-center" style="height:80vh;">
  <div class="card" style="width:340px; height: 280px;">
    ...
    <div class="card-body" style="background: lightgrey;">
          ...
          &nbsp 
          <p class="newuser" style="text-align: right;"><a href="register2.php"> New user </a></p>
          <p type="submit" class="forgotpassword" style="text-align: right;"><a href="forget2.php"> Forgot password? </a></p>
        </form>
    </div>
  </div>
</div>
